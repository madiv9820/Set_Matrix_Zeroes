...
class TestSolution(unittest.TestCase):
    ...
    def _run_case(self, matrix: List[List[int]]) -> List[int]:
        ...
        return self.__solution.setZeroes(matrix=matrix)


class SetMatrixZeroesTextTestResult(unittest.TextTestResult):
    ...
    def stopTestRun(self):
        ...
        print('\n' + '🧾' + '=' * 58)
        print('📚 Set Matrix Zeroes Final Summary')
...
if __name__ == '__main__':
    unittest.main(
        verbosity=2,
        testRunner=unittest.TextTestRunner(resultclass=SetMatrixZeroesTextTestResult)
    )
